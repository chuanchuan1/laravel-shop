                    ...
                    <user-addresses-create-and-edit inline-template>
                        <form class="form-horizontal" role="form" action="{{ route('user_addresses.store') }}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="contact_name" class="form-control" value="{{ old("contact_name", $address->contact_name)}} ">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label text-md-right col-sm-2">电话</label>
                                <div class="col-sm-9">
                                    <input type="text" name="contact_phone" class="form-control" value="{{ old("contact_phone", $address->contact_phone) }}">
                                </div>
                            </div>
